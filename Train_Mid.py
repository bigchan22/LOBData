...
if args.trainname:
    trainname = args.trainname+'_mid'
else:
    now = datetime.now()
    now.strftime("%m/%d/%Y, %H:%M:%S")
    date_time = now.strftime("%m_%d_%Y")
    trainname = date_time+'_mid'
device = args.device
...
print("XData loaded from: ", './TrainData/' + XDataname)
print("YData loaded from: ", './TrainData/' + YDataname)
Xdata = []
Ydata = []
Xtrain_data = []
Ytrain_data = []
...
PATH = 'results/best_model_' + modeltype + '_' + trainname
torch.save(best_model.state_dict(), PATH)

file_name = 'results/result_' + modeltype + '_' + trainname + '.txt'
...
with open("results/Val_loss_" + modeltype + '_' + trainname, "wb") as fp:  # Pickling
    pickle.dump(Val_loss, fp)
with open("results/Train_loss_" + modeltype + '_' + trainname, "wb") as fp:  # Pickling
    pickle.dump(Train_loss, fp)
with open("results/Accuracy_" + modeltype + '_' + trainname, "wb") as fp:  # Pickling
    pickle.dump(Accuracy, fp)
with open("results/F1_" + modeltype + '_' + trainname, "wb") as fp:  # Pickling
